...
function App() {
  ...
  const allSystems = [
    "All",
    ...new Set(
      weeks.flatMap((week) => week.systems_developing || [])
    ),
  ];
    ...
    <div style={styles.page}>
      <div style={styles.container}>
        <div style={styles.header}>
          <span style={styles.badge}>Invisible Worlds</span>
          <h1 style={styles.title}>Human Development Timeline</h1>
              ...
              {allSystems.map((system) => (
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    background:
                      activeSystem === system ? "#6366f1" : "#e0e7ff",
                    color:
                      activeSystem === system ? "white" : "#1e293b",
                  }}
                >
                  {system}
                </button>
